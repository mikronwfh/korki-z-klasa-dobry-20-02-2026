  ...
  <section id="cennik" className="section-padding bg-background">
    <div className="container mx-auto">
      <div className="text-center mb-12">
        <p className="text-sm font-semibold text-secondary uppercase tracking-wider mb-2">Cennik</p>
        <h2 className="text-3xl md:text-4xl font-extrabold text-foreground">
          Przejrzyste ceny
        </h2>
        <p className="text-muted-foreground mt-3 max-w-lg mx-auto">
          Wybierz opcję dopasowaną do Twoich potrzeb. Bez ukrytych kosztów.
        </p>
      </div>
